...
import 'dart:convert';
import 'helper_pengeluaran.dart';

class MyHomePageHelper extends StatefulWidget {
  final String email;
  final String ipAddress;
  const MyHomePageHelper({Key? key, required this.title, required this.email, required this.ipAddress})
      : super(key: key);

  final String title;

  @override
  State<MyHomePageHelper> createState() => _MyHomePageHelperState();
}

class _MyHomePageHelperState extends State<MyHomePageHelper> {
  ...
  Future<void> fetchData() async {
    ...
    try {
      final response = await http.post(
        Uri.parse(
            'http://${widget.ipAddress}/mobpro/get_data_helper.php'), // Ganti dengan URL server Anda
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(
                                height:
                                    25), // Jarak antara jam/tanggal dan tombol
                            Center(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => PengeluaranHelper(
                                        kotaAsal: tempatAwal,
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor:
                                      const Color.fromARGB(255, 71, 169, 146),
                                  minimumSize: Size((screenWidth - 125),
                                      50), // Ukuran minimum tombol (panjang, lebar)
                      ...
                      const Align(
                        ...
                        child: Padding(
                          padding:
                              EdgeInsets.only(left: 40.0), // Padding kiri 30.0
                          child: Text(
                            'Armada',
                            style: TextStyle(
                              fontSize: 22,
                      ...
                      Container(
                        height: 100,
                        width:
                            screenWidth - 75, // Atur lebar container tambahan
                        decoration: BoxDecoration(
                          color: const Color.fromARGB(255, 255, 255, 255),
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsets.only(
                                    left: 15.0), // Padding kiri 20
                                child: CircleAvatar(
                                  radius: 35, // Ukuran radius lingkaran
                                  backgroundColor: Colors
                                      .grey, // Warna latar belakang lingkaran
