...
class AktivitasHelper extends StatefulWidget {
  final String email;
  final String ipAddress;
  const AktivitasHelper({Key? key, required this.email, required this.ipAddress}) : super(key: key);

  @override
  State<AktivitasHelper> createState() => _AktivitasHelperState();
}

class _AktivitasHelperState extends State<AktivitasHelper> {
  String tempatAwal = '';
  String tempatAkhir = '';
  String jamBerangkat = '';
  ...
  child: Container(
    ...
    child: currentData.toString() == '[]'
        ? Center(child: Text('Tidak ada data ditemukan', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold),))
        : ListView.builder(
